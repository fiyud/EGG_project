...
from utilis.infer_utils import draw_segmentation_map, get_outputs
from torchvision.transforms import transforms as transforms
from class_names import INSTANCE_CATEGORY_NAMES as cass_names
from maskrcnn.maskrcnn_mobilev4 import get_mobilev4_model_instance_segmentation
...
model = get_mobilev4_model_instance_segmentation("MobileNetV4ConvSmall", num_classes = 91)
