...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--model", default="MobileNetV4ConvSmall", type=str, help="model name")
...
def main(args):
    ...
    model = get_mobilev4_model_instance_segmentation(args.model, num_classes = 6)
    print(model)
    model.to(device)
